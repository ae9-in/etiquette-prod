...
const Pricing: React.FC = () => {
   return (
      <div className="bg-[#fcfcfd] min-h-screen selection:bg-indigo-100">
         {/* Header Section */}
         <header className="pt-16 pb-12 md:pt-24 md:pb-20 px-4 md:px-6 bg-white border-b border-slate-100 relative overflow-hidden text-center">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
               ...
               <h1 className="text-4xl md:text-5xl lg:text-8xl font-black text-slate-900 tracking-tighter mb-6 italic font-['Bangers']">
         ...
         <section className="py-16 md:py-24 px-4 md:px-6">
            <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
               {/* Digital Package */}
               <div className="p-8 md:p-12 rounded-[32px] md:rounded-[56px] border-2 border-slate-100 bg-white flex flex-col hover:border-indigo-100 transition-all duration-500 shadow-sm">
               ...
               <div className="p-8 md:p-14 rounded-[32px] md:rounded-[64px] bg-slate-900 text-white shadow-[0_40px_80px_-20px_rgba(79,70,229,0.3)] relative overflow-hidden flex flex-col">
         ...
         <section className="py-24 bg-slate-50">
            <div className="max-w-5xl mx-auto px-6">
               <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-16 tracking-tight text-center">Feature Comparison</h2>
               <div className="bg-white border border-slate-200 rounded-[24px] md:rounded-[48px] overflow-hidden shadow-xl overflow-x-auto">
         ...
         <footer className="py-20 bg-slate-900 text-white text-center">
            <div className="max-w-7xl mx-auto px-6">
               ...
               <div className="flex flex-wrap justify-center gap-6 md:gap-12 text-[10px] font-black uppercase tracking-[0.3em] text-indigo-400">
