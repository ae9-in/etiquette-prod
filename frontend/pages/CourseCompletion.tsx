...
const CourseCompletion: React.FC<CourseCompletionProps> = ({ state }) => {
  ...
  if (!course || !progress) {
    console.warn('[CourseCompletion] Course or progress not found:', { id, courseFound: !!course, progressFound: !!progress });
    return <Navigate to="/" />;
  }
        ...
        {isPassed ? (
          <div className="animate-in fade-in slide-in-from-bottom-12 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link to="/employee" className="px-14 py-6 bg-slate-900 text-white rounded-[28px] font-black text-xs uppercase tracking-widest hover:bg-indigo-600 shadow-2xl transition-all">Go to Workspace</Link>
