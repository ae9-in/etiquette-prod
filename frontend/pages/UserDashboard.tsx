        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-8">
            ...
            <div className="mt-12 flex justify-end gap-4">
              <Link to="/employee" className="px-10 py-5 bg-slate-100 text-slate-600 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-200 transition-all">
                Return to Workspace
              </Link>
